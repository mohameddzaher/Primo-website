// ============================================
// PRIMO API - Cleanup Seed/Fake Data Script
// ============================================
...
async function main(): Promise<void> {
  ...
  try {
    ...
    // 4. Delete fake users (keep admin@primo.com, staff@primo.com, user@primo.com)
    ...
    console.log('  - Admin accounts (admin@primo.com, staff@primo.com)');
    console.log('  - User account (user@primo.com)');
