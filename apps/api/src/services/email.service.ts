  ...
  const html = `
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          <h2>Welcome to PRIMO, ${firstName}!</h2>
          <p>Thank you for creating an account with us. We're excited to have you as part of our community.</p>
          <p>Start exploring our premium collection of home appliances and discover products that will transform your living space.</p>
...
export const sendPasswordResetEmail = async (
  ...
  return sendEmail({
    to: email,
    subject: 'Reset Your Password - PRIMO',
    html,
  });
};
...
export const sendNewsletterConfirmation = async (email: string): Promise<boolean> => {
  ...
  return sendEmail({
    to: email,
    subject: 'Welcome to PRIMO Newsletter',
    html,
  });
};
